...
// StrategyScriptDto is the only shape a saved strategy script leaves the domain in. It carries
// what the strategy script remembers, never what it would compute: a strategy script is a recipe,
...
// else reads PublishedStrategyScriptDto, which has nowhere to put one — so "a stranger
