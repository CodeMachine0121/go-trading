...
// StrategyBotConditionDto is one condition as it travels in and out of the domain:
...
// comparison. Which fields are filled is settled in StrategyBotConditionDomain, so
// nothing downstream has to guess.
type StrategyBotConditionDto struct {
	// Operator is "and" or "or" on a group, and empty on a comparison.
	Operator string `json:"operator,omitempty"`
	// Conditions are what a group joins. Empty on a comparison.
	Conditions []StrategyBotConditionDto `json:"conditions,omitempty"`
