...
### US-01 — [priority: P0]
**As a** 專案維護者或策略腳本程式，**I want** 自己寫一段算式，讓系統用指定根數的 K 線算出指標，
...
### US-02 — [priority: P0]
**As a** 專案維護者或策略腳本程式，**I want** 在 K 線不夠或根數不合理時被明確擋下並告知實情，
