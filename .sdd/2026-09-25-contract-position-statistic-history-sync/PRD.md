...
- **合約 K 線那一份讓系統壞掉時，持倉統計那一份不開始**：輪次收在失敗，持倉統計走到第 0 天。系統已經不可信，不在那之後接著寫另一份資料；合約 K 線那一份只是**來源不答話**時則照常補持倉統計。
- **一份檔案裡有讀不懂的數字或時間，就是整份檔案讀不懂**：照「歷史資料庫不答話」處理（記下原因、放棄剩下的日子、輪次照樣成功），不當成那一筆缺值——缺值是檔案沒寫，讀不懂是檔案壞了，兩者要讀者做的事不一樣。檔案少了需要的欄位也一樣。
