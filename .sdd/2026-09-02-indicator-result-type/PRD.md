...
**As a** 策略腳本研究者, **I want** 在送出計算時宣告這次算式產出的值是哪一種,
...
**As a** 策略腳本研究者, **I want** 算式產出的形狀與宣告不符時被明確告知,
...
**As a** 策略腳本研究者, **I want** 「什麼都沒算出來」與「算出一串但裡面沒有值」都被當成正常結果,
...
**As a** 策略腳本研究者, **I want** 取 K 線、根數限制等既有規則在任何種類下都一樣,
